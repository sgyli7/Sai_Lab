...
def main():
 ...
 if a.resume:
  ...
  for key in ['source_sha256','template_sha256','variant','std','bound','feet','cuda_graphs','envs','steps','seed','control_sha256','code_sha256','reward','constraints','controller','teacher_retention','teacher_weight','course_names','velocity_observer']:
