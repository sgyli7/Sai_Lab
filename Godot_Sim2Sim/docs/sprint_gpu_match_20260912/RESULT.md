...
|---|---:|---:|---:|---|---:|
| S05 基准 | 120/128 | 0.2252 | 0 | 失败 | 0 |
| 原脚底 GPU 训练 | 51/128 | 0.2983 | 0 | 通过 | 70 |
| 游戏脚底 GPU 训练 | 53/128 | 0.2873 | 0 | 失败 | 67 |
| 同代码正值奖励对照 | 48/128 | 0.2877 | 0 | 失败 | 72 |
| CaT 约束学习 | 122/128 | 0.2585 | 0 | 通过 | 6 |
