...
r=Path('results/sprint_gpu_match_20260912');out=r/'anchor_parity';out.mkdir(exist_ok=False)
assert torch.cuda.is_available();torch.set_num_threads(4)
torch.backends.cuda.matmul.allow_tf32=False;torch.backends.cudnn.allow_tf32=False
sources={'s05':'results/sprint_20260912/runs/s05_native_handoff/final.onnx','running':'results/sprint_exit_20260912/running_source/policy.onnx','motion_state':'results/sprint_exit_20260912/runs/e04_motion_visible/final.onnx'}
