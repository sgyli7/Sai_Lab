...
r=Path('results/sprint_gpu_match_20260912');out=r/'gpu_contract_attempt02';out.mkdir(exist_ok=False)
...
atomic_json(out/'control.json',dict(passed=True,control_max_abs=error,rows=700))
