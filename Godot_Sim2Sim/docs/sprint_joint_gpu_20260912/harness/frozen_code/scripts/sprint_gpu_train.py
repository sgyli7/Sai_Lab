...
def main():
 ...
 p.add_argument('--controller',choices=['split','shared'],default='split');p.add_argument('--teacher-replay',type=Path);p.add_argument('--teacher-weight',type=float,default=.02);p.add_argument('--constraints',choices=['none','positive','cat'],default='none');p.add_argument('--cuda-graphs',action='store_true');p.add_argument('--seed',type=int,default=951101);p.add_argument('--resume',type=Path);a=p.parse_args()
