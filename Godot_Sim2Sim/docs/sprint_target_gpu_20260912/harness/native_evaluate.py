...
assert a.iteration in json.loads((r/'protocol.json').read_text())['endpoints']
assert json.loads((r/'train/completed.json').read_text())['completed']
actor=r/'train'/f'iteration_{a.iteration:03d}'/'actor.onnx';out=r/f'native_{a.iteration:03d}'
